...
public class AzureServicePrincipalCredentialsConvertorTest {
    ...
    public void canConvertAValidSecret() throws Exception {
        ...
        try (InputStream is = get("valid.yaml")) {
            ...
            assertThat(
                    "credential text is mapped correctly",
                    credential.getPlainClientSecret(),
                    is("client-secret-secret-string"));
    ...
    private static final InputStream get(String resource) {
        InputStream is = AzureServicePrincipalCredentialsConvertorTest.class.getResourceAsStream(
                "AzureServicePrincipalCredentialsConvertorTest/" + resource);
        if (is == null) {
